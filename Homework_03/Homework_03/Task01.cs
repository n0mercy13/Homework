...
namespace Homework_03
{
    ...
    public class ComplexNumber
    {
        ...
        public override string ToString()
        {
            if(IsInteger(Re) && IsInteger(Im))
            {
                if (Re >= 0 && Im >= 0)
                    return $"{Re:F0} + {Im:F0}i";
                else if (Re < 0 && Im >= 0)
                    return $"- {(Re * -1):F0} + {Im:F0}i";
                else if (Re >= 0 && Im < 0)
                    return $"{Re:F0} - {(Im * -1):F0}i";
                else
                    return $"- {(Re * -1):F0} - {(Im * -1):F0}i";
            }
            else
            {
                if (Re >= 0 && Im >= 0)
                    ...
                    return $"- {(Re * -1):F2} + {Im:F2}i";
                else if (Re >= 0 && Im < 0)
                    return $"{Re:F2} - {(Im * -1):F2}i";
                else
                    return $"- {(Re * -1):F2} - {(Im * -1):F2}i";
            }
        }
